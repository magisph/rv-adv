...
function sanitizeReport(result, interval, payload) {
  ...
  return {
    ...
    ignoredOutOfScope: metrics.ignoredOutOfScope ?? 0,
    ignoredBySimilarity: metrics.ignoredBySimilarity ?? 0,
    ignoredDuplicateProcess: metrics.ignoredDuplicateProcess ?? 0,
    ...
    filterSamples: Array.isArray(result?.filterSamples) ? result.filterSamples.slice(0, 10) : [],
